...
namespace Application.Services
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(IOrderRepository orderRepository, IRepository<Orderstatus> orderStatusRepository, IRepository<Orderitem> orderItensRepository, IRepository<Payment> orderPaymentRepository)
        {
